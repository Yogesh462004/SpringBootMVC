...
public class BootMvc01Application implements CommandLineRunner {

    @Autowired
    private Environment env;  // Inject Spring Environment to read properties

    public static void main(String[] args) {
        SpringApplication.run(BootMvc01Application.class, args);
    }
